...
(21, 'Printer', 'Peralatan Kantor', 'Baik', 2, 'Epson L110 merupakan printer yang menggunakan sistem CIS atau Ink tank, sehingga tidak perlu menggunakan cartridge dan dalam pengisian tintanya cukup isi ulang.', 'epsonl110.jpg');
...
ALTER TABLE `permintaan`
  ADD PRIMARY KEY (`id_permintaan`),
  ADD KEY `permintaan_ibfk_1` (`id`),
  ADD KEY `permintaan_ibfk_2` (`id_aset`);
...
--
ALTER TABLE `aset`
  MODIFY `id_aset` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `laporan`
  ADD CONSTRAINT `laporan_ibfk_1` FOREIGN KEY (`id`) REFERENCES `akun` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `permintaan`
--
ALTER TABLE `permintaan`
  ADD CONSTRAINT `permintaan_ibfk_1` FOREIGN KEY (`id`) REFERENCES `akun` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `permintaan_ibfk_2` FOREIGN KEY (`id_aset`) REFERENCES `aset` (`id_aset`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
